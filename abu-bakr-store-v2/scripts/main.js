...
async function initializeApp() {
    ...
    await categoryManager.init();
        ...
        await Promise.all([
            ...
            loadComponent('carousel-container', '/abu-bakr-store-v2/components/carousel/carousel.html'),
            loadComponent('features-container', '/abu-bakr-store-v2/components/features/features.html'),
            loadComponent('featured-deals-container', '/abu-bakr-store-v2/components/featured-deals/featured-deals.html'),
            loadComponent('best-deals-container', '/abu-bakr-store-v2/components/best-deals/best-deals.html'),
            loadComponent('popular-categories', '/abu-bakr-store-v2/components/popular-categories/popular-categories.html'),
            loadComponent('fresh-finds', '/abu-bakr-store-v2/components/fresh-finds/fresh-finds.html'),
            await loadComponent('promo-banners', '/abu-bakr-store-v2/components/promo-banners/promo-banners.html'),
            loadComponent('most-popular', '/abu-bakr-store-v2/components/most-popular/most-popular.html'),
            loadComponent('shop-with-us', '/abu-bakr-store-v2/components/shop-with-us/shop-with-us.html'),
            loadComponent('subscribe-section', '/abu-bakr-store-v2/components/subscribe/subscribe.html'),
            await loadComponent('footer', '/abu-bakr-store-v2/components/footer/footer.html')
        ...
        if (mainContainer) {
            mainContainer.innerHTML = '<div class="alert alert-danger">Failed to load application. Please refresh the page.</div>';
        }
    }
}
        ...
        button.addEventListener('click', (e) => {
            ...
            const product = {
                ...
                oldPrice: card.querySelector('.old-price') ? 
                    parseFloat(card.querySelector('.old-price').textContent.replace('£', '')) : null
            };
...
await loadComponent('start-cart-container', '/abu-bakr-store-v2/components/start-cart/start-cart.html');
await initializeStartCart();
        ...
        function renderSuggestions(suggestions) {
            ...
            suggestions.forEach(product => {
                ...
                div.addEventListener('click', () => {
                    window.location.href = `/abu-bakr-store-v2/pages/product/product-page.html?id=${product.id}`;
                });
