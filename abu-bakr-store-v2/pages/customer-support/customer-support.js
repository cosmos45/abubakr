...
async function initializeCustomerSupportPage() {
    try {
        ...
        await Promise.all([
            ...
            loadComponent('locations-section', '/abu-bakr-store-v2/components/locations/locations.html'),
            loadComponent('footer', '/abu-bakr-store-v2/components/footer/footer.html'),
            await loadComponent('faq-section', '/abu-bakr-store-v2/components/faq/faq.html')
        ]);
