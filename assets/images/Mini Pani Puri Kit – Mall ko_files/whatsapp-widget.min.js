const waWidgetAddStyleToHead = function (e, t) {
    ...
    (a += `#wa .wa__btn_popup .wa__btn_popup_icon { height: ${e.iconSize}px; width: ${e.iconSize}px;}`),
      (a += `#wa .wa__btn_popup .wa__btn_popup_icon:before { background-size: ${Math.round(0.54 * e.iconSize)}px auto; -webkit-background-size: ${Math.round(0.54 * e.iconSize)}px auto;}`),
      ...
      "tatyanaaceeva.myshopify.com" === window.Shopify.shop &&
        (a += ".wa__btn_popup .wa__btn_popup_icon {display: none !important;}"),
      "box-liquid.myshopify.com" === window.Shopify.shop &&
        "" === e.title &&
        "" === e.description &&
        (a += ".wa__popup_chat_box .wa__popup_heading {display: none;}"),
      "takeanalytics.myshopify.com" === window.Shopify.shop &&
        (a += ".wa__btn_popup, .wa__popup_chat_box {z-index: 0;}"),
      window.Shopify.designMode &&
        "free" === t &&
        (a += ".wa__popup_tooltiptext {left: 18%; margin-left: 0}"),
      window.Shopify.designMode ||
        "Dawn" !== window.Shopify.theme.name ||
        (a += ".wa__popup_tooltiptext {font-size: 11px;}"),
  ...
  waWidgetCheckTranslations = function (e, t) {
    let a = window.Shopify.locale;
    return (
      "zh-TW" === a &&
        "computercenrtre.myshopify.com" !== window.Shopify.shop &&
        (a = "zh"),
      "en" !== a && !!e.enabled && !0 === e.enabled && !!e[a] && !!e[a][t]
    );
  },
  ...
  waWidgetCheckShowInPage = function (e) {
      ...
      );
    {
      ...
      if (
        ("/" === t || t === `/${a}` || t === `/${a}/`
          ? (i = "homepage")
          : 0 === t.indexOf("/products") ||
              (0 === t.indexOf("/collections") &&
                t.indexOf("/products/") > 10) ||
              0 === t.indexOf(`/${a}/products`) ||
              (0 === t.indexOf(`/${a}/collections`) &&
                t.indexOf("/products/") > 10)
            ? (i = "products")
            : 0 === t.indexOf("/collections") ||
                0 === t.indexOf(`/${a}/collections`)
              ? (i = "collections")
              : 0 === t.indexOf("/cart") || 0 === t.indexOf(`/${a}/cart`)
                ? (i = "cart")
                : 0 === t.indexOf("/pages/") || 0 === t.indexOf(`/${a}/pages/`)
                  ? (i =
                      0 === t.indexOf("/pages/")
                        ? t.substr(7)
                        : t.substr(8 + a.length))
        ...
        return "include_pages" !== e.displayCondition;
      if ("include_pages" === e.displayCondition)
        return e.includePages.includes(i);
      if ("exclude_pages" === e.displayCondition)
        return !e.excludePages.includes(i);
    }
  },
  waWidgetUrlSet = function (e, t) {
    ...
    if (
      ...
      )).replace(/\[njwa_page_url\]/gi, window.location.href)).replaceAll(
        /\n/gi,
        "%0A",
      )),
      ...
      if (-1 !== e.number.indexOf("wa.me"))
        return (a += e.number), (a += e.predefinedText ? "?text=" + i : "");
      let o = t.urlSettings[waWidgetMobileCheck() ? "onMobile" : "onDesktop"];
      if ((o || (o = "api"), "protocol" === o))
        return (
          "whatsapp://send?phone=" +
          e.number.replace(/[^0-9]/gi, "") +
          (e.predefinedText ? "&text=" + i : "")
        );
      (a += "https://" + o + ".whatsapp.com/send?phone="),
        (a += e.number.replace(/[^0-9]/gi, "")),
        (a += e.predefinedText ? "&text=" + i : "");
    }
    return a;
  },
  ...
  waWidgetRenderHtml = function () {
    ...
    if (
      ...
      0 !== window.location.pathname.indexOf("/password") &&
        0 !== window.location.pathname.indexOf(`/${a}/password`))
    ) {
      ((e = window.seedgrow_wa_data
        ...
        : window.seedgrow_whatsapp_data
          ...
          : {
            ...
            }).options.styles = window.seedgrow_widget_setting),
      ...
      let i = waWidgetCheckShowInPage(e.options.display);
      if (i && e.accounts) {
        let o = [];
        e.accounts.forEach((t, a) => {
          if (t.showWidget) {
            if ("free" === e.plans) o.push(t);
              ...
              let i = njtWhatsApp.getBackTime(t, e);
              "online" === i && o.push(t);
            } else o.push(t);
          }
        });
        ...
        if (
          ...
          o.forEach((t) => {
            if (!0 === waWidgetCheckTranslations(e.translations, t.accountId)) {
              let a = waWidgetTranslationText(t.accountId);
              (a = (a = (a = a.replaceAll(
                /\[sgwa_page_title\]/gi,
                "[njwa_page_title]",
              )).replaceAll(
          ...
          if (1 === o.length && e.options.styles.useClickToChat) {
            if (
              (!1 == waWidgetMobileCheck() &&
                "ON" == n.display.showOnDesktop) ||
              (!0 == waWidgetMobileCheck() && "ON" == n.display.showOnMobile)
            ) {
              let l = "OFF" === n.styles.isShowBtnLabel ? "none" : "block",
                p = "left" == n.styles.btnPosition ? "100%" : "unset",
                d = "right" == n.styles.btnPosition ? "100%" : "unset",
                r = "left" == n.styles.btnPosition ? "7px" : "0px",
                c = "right" == n.styles.btnPosition ? "7px" : "0px",
                w =
            ...
            if (
              ...
              (njtWhatsApp.createWidget(document.getElementById("wa"), s),
              Shopify.designMode &&
                "free" === e.plans &&
                "ON" == s.options.styles.isShowPoweredBy)
            ) {
              let y = document.createElement("div"),
                m = document.createElement("a"),
                u = document.createTextNode("Contact us");
              m.appendChild(u),
                (m.href = `https://${t.getAttribute("data-shop-domain")}/admin/apps/whatsapp-chat-12/?&tab=contact`),
                (m.style.color = "#fff");
              let _ = document.createTextNode(" to remove this label");
              y.appendChild(m), y.appendChild(_);
              let f = document.querySelector(".wa__popup_tooltiptext");
              f.appendChild(y);
            }
          } else
  ...
  waLoadJsFileAndCreateWidget = function (e, t, a, i = !0) {
    let o = document.createElement("script");
    o.setAttribute("src", e),
      o.setAttribute("type", "text/javascript"),
      o.setAttribute("async", i),
      ...
      o.addEventListener("load", () => {
        if (
          ...
          let e = document.getElementById("wa"),
            ...
            n = document.createTextNode("contact us");
          o.appendChild(n),
            (o.href = `https://${e.getAttribute("data-shop-domain")}/admin/apps/whatsapp-chat-12/?&tab=contact`),
            (o.style.color = "#fff");
          let s = document.createTextNode("Please "),
            l = document.createTextNode(" if you don't want to show this icon");
          i.appendChild(s), i.appendChild(o), i.appendChild(l);
          let p = document.querySelector(".wa__popup_tooltiptext");
          p.appendChild(i);
        }
      }),
    ...
    if (
      ...
      e.length > 0 &&
        e.forEach(function (e) {
          let t = document.createElement("sup");
          (t.className = "wa__widget_notification_badge"), e.append(t);
        });
    }
  };
"loading" !== document.readyState
  ...
  : document.addEventListener("DOMContentLoaded", function () {
      initWhatsAppWidget();
      let e = document.getElementById("wa__widget_simple");
      e &&
  ...
  window.addEventListener("resize", function (e) {
    Shopify.designMode &&
      ((document.getElementById("wa").innerHTML = ""), waWidgetRenderHtml());
  });
