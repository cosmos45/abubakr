...
export const productData = {
    ...
    categoryProducts: [
        {
            ...
            price: 1.99,
            oldPrice: 2.49,
            imageUrl: "/abu-bakr-store-v2/assets/images/products/carrots.jpg",
        ...
        },
        {
            ...
            price: 2.49,
            oldPrice: 2.99,
            imageUrl: "/abu-bakr-store-v2/assets/images/products/tomatoes.jpg",
            categoryId: 2,
            isPublished: true,
            isFeatured: true,
            choices: {
        ...
        },
        {
            ...
            name: "Fresh Spinach",
            price: 1.79,
            imageUrl: "/abu-bakr-store-v2/assets/images/products/spinach.jpg",
            categoryId: 2,
            isPublished: true,
            choices: {
                weight: ["250g", "500g"],
    ...
    getProductsByCategory(categoryId) {
        return this.categoryProducts.filter(p => 
            p.categoryId === categoryId && p.isPublished
        );
    },
